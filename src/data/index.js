...
export const claimTypeOptions = ['Reparación', 'Ajuste', 'Recupero'];

export const recoveryTypeOptions = ['Ninguno', 'Reclamo', 'Recupero'];

export const creditorTypeOptions = ['Taller', 'Particular', 'Proveedor', 'Otro'];

export const stroConceptOptions = [
  'Actualización valor de mano de obra',
  'Administración',
  'Ampliación mano de obra + flete',
  ...
  'Honorarios por recupero',
  'Intereses',
  'IVA diferencial',
  'Lavado y detallado',
  'Materiales adicionales',
  'No STR taller por diferencia de franquicia',
  'Otros honorarios destino off',
  'Pulido - llantas',
...
export const claims = [
  {
    ...
    stroNumber: '15707',
    repairNumber: '15707',
    claimType: 'Reparación',
    recoveryType: 'Reclamo',
    creditorType: 'Taller',
    creditorName: 'Taller Central',
    hasInvoice: false,
    otherConcepts: ['Diferencia repuestos', 'Financiación', 'Pulido - llantas'],
    state: 'Documentación',
  ...
  },
  {
    ...
    creditorType: 'Taller',
    creditorName: 'Carrocerías del Sur',
    hasInvoice: true,
    otherConcepts: ['Gastos de gestoría', 'Traslado / grúa'],
    state: 'Taller',
    ...
    partsDetail: [
      ...
      {
        code: '221',
        description: 'Espejos laterales cromados',
        quantity: 2,
        unitPrice: 48250,
        total: 96500,
      },
  ...
  },
  {
    ...
    repairNumber: '15590',
    claimType: 'Reparación',
    recoveryType: 'Ninguno',
    creditorType: 'Proveedor',
    creditorName: 'Red Fast Track',
    hasInvoice: true,
    otherConcepts: ['Actualización valor de mano de obra'],
    state: 'Fast Track',
  ...
  },
  {
    ...
    claimType: 'Ajuste',
    recoveryType: 'Ninguno',
    creditorType: 'Particular',
    creditorName: 'Jorge Ramírez',
    hasInvoice: false,
    otherConcepts: [],
    state: 'Ingreso',
  ...
  },
  {
    ...
    recoveryType: 'Reclamo',
    creditorType: 'Particular',
    creditorName: 'Carolina Suárez',
    hasInvoice: true,
    otherConcepts: ['Intereses'],
    state: 'Cerrado',
    ...
    partsDetail: [
      {
        code: '305',
        description: 'Paragolpes trasero',
        quantity: 1,
        unitPrice: 120500,
        total: 120500,
      },
